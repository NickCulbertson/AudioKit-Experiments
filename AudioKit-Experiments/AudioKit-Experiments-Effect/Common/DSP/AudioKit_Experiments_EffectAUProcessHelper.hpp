//
//  AudioKit_Experiments_EffectAUProcessHelper.hpp
...
#include <vector>
#include "AudioKit_Experiments_EffectDSPKernel.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(AudioKit_Experiments_EffectDSPKernel& kernel, UInt32 inputChannelCount, UInt32 outputChannelCount)
    : mKernel{kernel},
...
private:
    AudioKit_Experiments_EffectDSPKernel& mKernel;
