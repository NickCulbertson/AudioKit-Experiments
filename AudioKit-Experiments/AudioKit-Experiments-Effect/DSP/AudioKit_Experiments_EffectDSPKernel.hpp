//
//  AudioKit_Experiments_EffectDSPKernel.hpp
...
#import "AudioKit_Experiments_Effect-Swift.h"
#import "AudioKit_Experiments_EffectParameterAddresses.h"

/*
 AudioKit_Experiments_EffectDSPKernel
 As a non-ObjC class, this is safe to use from render thread.
 */
class AudioKit_Experiments_EffectDSPKernel {
public:
    ...
    void setParameter(AUParameterAddress address, AUValue value) {
        switch (address) {
            case AudioKit_Experiments_EffectParameterAddress::gain:
                mGain = value;
                break;
                // Add a case for each parameter in AudioKit_Experiments_EffectParameterAddresses.h
        }
    }
    ...
    void process(std::span<float const*> inputBuffers, std::span<float *> outputBuffers, AUEventSampleTime bufferStartTime, AUAudioFrameCount frameCount) {
        /*
         ...
         modify the check in [AudioKit_Experiments_EffectAudioUnit allocateRenderResourcesAndReturnError]
         */
