...
private let log = Logger(subsystem: "com.MobyPixel.AudioKit-Experiments.AudioKit-Experiments-MIDI", category: "AudioUnitViewController")

public class AudioUnitViewController: AUViewController, AUAudioUnitFactory {
    var audioUnit: AUAudioUnit?
    
    var hostingController: HostingController<AudioKit_Experiments_MIDIMainView>?
	...
	*/
    ...
    public func createAudioUnit(with componentDescription: AudioComponentDescription) throws -> AUAudioUnit {
        audioUnit = try AudioKit_Experiments_MIDIAudioUnit(componentDescription: componentDescription, options: [])
        
        guard let audioUnit = self.audioUnit as? AudioKit_Experiments_MIDIAudioUnit else {
            log.error("Unable to create AudioKit_Experiments_MIDIAudioUnit")
            return audioUnit!
        }
        ...
        audioUnit.setupParameterTree(AudioKit_Experiments_MIDIParameterSpecs.createAUParameterTree())
    ...
    private func configureSwiftUIView(audioUnit: AUAudioUnit) {
        ...
        let content = AudioKit_Experiments_MIDIMainView(parameterTree: observableParameterTree)
